...
public class MiserBoy extends Boy {
	 ...
	 */
	public MiserBoy(String name, int attractiveness, int intelligence, int budget, int min_attraction_of_girl) {
	...
	@Override
	public ArrayList<Gift> Gifting(ArrayList<Gift> allgifts) {
	...
	public double findHappiness() {
		// TODO Auto-generated method stub
		double ans = this.getBudget() - this.getMoney_spent();
		return ans;
	}
