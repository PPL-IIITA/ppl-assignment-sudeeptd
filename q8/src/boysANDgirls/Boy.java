...
abstract public class Boy {
	 ...
	 * @return
	 */
	abstract public ArrayList<Gift> Gifting(ArrayList<Gift> allgifts, ArrayList<Gift> givengifts);
	...
	public ArrayList<Girl> getExgfs() {
		return exgfs;
	}

	public void setExgfs(ArrayList<Girl> exgfs) {
		this.exgfs = exgfs;
	}
